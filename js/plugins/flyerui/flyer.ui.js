...
define(function(require, exports, module) {
    ...
    window.flyer = function() {
        ...
        return {
            ...
            msg: function(msg, options) {
                ...
                options.time = typeof(options.time) != "undefined" ? options.time : 2000;
                if (options.time > 0) {
                    setTimeout(function() {
    ...
    var parts = {
        ...
        builderContniaer: function(options) {
            ...
            contniaer.className = class_col.dialog_container + " " + class_col.flyer_adim + " " + class_col.flyer_Alert + " " + (global.dialog_type == dialogType.msg ? class_col.flyer_msg : "");
        ...
        builderButton: function(button) {
            ...
            a.className = "flyer-button flyer-dialog-btn " + button.style || "";
