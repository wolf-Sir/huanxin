...
define(function(require, exports, module) {
    ...
    var Upload = function(options) {
        ...
        this.options.autoUpload = this.options.autoUpload ? this.options.autoUpload : true;
    };
                ...
                timer = setInterval(function() {
                    ...
                    if (res) {
                        ...
                        try {
                            ...
                            res = {};
                            return flyer.msg('请对上传接口返回JSON字符', msgConf);
                        }
